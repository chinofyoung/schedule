...
import { Nurse, NursePosition } from "../../types/nurse";
import Link from "next/link";

type FormData = Omit<Nurse, "id">;
...
export default function NurseForm({
  ...
  const {
    ...
    defaultValues: nurse
      ...
      : {
          ...
          lastName: "",
          mobileNumber: "",
          position: "Nurse 1" as NursePosition,
        },
  });
  const nursePositions: NursePosition[] = [
    "Nurse 1",
    "Nurse 2",
    "Nurse 3",
    "Nurse 4",
  ...
  const getPositionCategory = (position: NursePosition) => {
  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      ...
      alert("An error occurred while saving the nurse.");
    } finally {
